...
- [built] context-cli-toolchain
  ...
  - **Sources**: `dev_cycle/__init__.py`, `dev_cycle/__main__.py`, `dev_cycle/cli.py`, `dev_cycle/context/__init__.py`, `dev_cycle/context/build_assist.py`, `dev_cycle/context/scaffold.py`, `dev_cycle/context/manifest.py`, `dev_cycle/context/audit.py`, `dev_cycle/context/docs.py`, `dev_cycle/context/fingerprint.py`, `dev_cycle/context/impact.py`, `dev_cycle/context/update_plan.py`, `dev_cycle/context/query_lint.py`, `dev_cycle/context/migrate_plan.py`, `tools/__init__.py`, `tools/context_build_assist.py`, `tools/context_scaffold.py`, `tools/context_manifest.py`, `tools/context_audit.py`, `tools/context_docs.py`, `tools/context_fingerprint.py`, `tools/context_impact.py`, `tools/context_migrate_plan.py`, `tools/context_query_lint.py`, `tools/context_update_plan.py`
...
- [planned] deterministic-test-coverage
  ...
  - **Sources**: `tests/test_dev_cycle_cli.py`, `tests/test_context_build_assist.py`, `tests/test_context_scaffold.py`, `tests/test_context_manifest.py`, `tests/test_context_audit.py`, `tests/test_context_docs.py`, `tests/test_context_fingerprint.py`, `tests/test_context_impact.py`, `tests/test_context_update_plan.py`, `tests/test_context_query_lint.py`, `tests/test_context_migrate_plan.py`, `tests/test_context_toolchain.py`, `tests/test_packaging.py`, `tests/fixtures/valid-context/CONTEXT_PLAN.md`, `tests/fixtures/valid-context/README.md`, `tests/fixtures/valid-context/src/release.py`, `tests/fixtures/valid-context/.dev-cycle/context/config.yaml`, `tests/fixtures/valid-context/.dev-cycle/context/GLOSSARY.md`, `tests/fixtures/valid-context/.dev-cycle/context/release/packaging.md`, `tests/fixtures/valid-context/.dev-cycle/context/_validation/release-packaging.md`, `tests/fixtures/broken-context/CONTEXT_PLAN.md`, `tests/fixtures/broken-context/README.md`, `tests/fixtures/broken-context/src/release.py`, `tests/fixtures/broken-context/.dev-cycle/context/config.yaml`, `tests/fixtures/broken-context/.dev-cycle/context/GLOSSARY.md`, `tests/fixtures/broken-context/.dev-cycle/context/release/packaging.md`
