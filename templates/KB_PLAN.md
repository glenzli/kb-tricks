...
Describe the repository architecture and why the KB is divided into the task groups below.
...
- [planned] example-task
  - **ID**: `example-task`
  - **KB**: `.agent/kb/example/task.md`
  - **Sources**: `src/example.ts`
  - **Focus**: Cross-module contract, design trade-offs, and edge behavior.
  - **Tags**: `example`
  - **Docs Comparison**: Existing docs have overview only; KB should capture Agent retrieval anchors.
  - **Status**: `planned`
  - **LastValidated**: ``
